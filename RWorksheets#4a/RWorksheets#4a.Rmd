...
randomNumber <- sample(1:50, 1)

# Prompt the user to input a number
userInput <- as.integer(readline(prompt="Enter a number between 1 and 50: "))

# Check if the input number is in the specified range
if (isInRange(userInput, c(1, 50))) {
 # Display the input number
 print(userInput)
} else {
 # Display a string indicating that the input number is out of range
 print("The number selected is beyond the range of 1 to 50")
}

# Check if the randomly generated number is 20
if (randomNumber == 20) {
 # Display TRUE
 print(TRUE)
} else {
