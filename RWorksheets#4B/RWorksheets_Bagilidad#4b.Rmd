...
male_subset <- data_shoes[data$Gender == "M",]
male_subset

female_subset <- data_shoes[data$Gender == "F",]
female_subset
...
# Add a legend
legend("topright", names(data), cex = 0.10, fill = rainbow(length(data)))
```
...
data <- read.xlsx("alexa-file.xlsx")
data
